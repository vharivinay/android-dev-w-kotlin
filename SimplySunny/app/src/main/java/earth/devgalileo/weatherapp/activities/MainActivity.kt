...
import earth.devgalileo.weatherapp.classes.GetAddressFromLatLong
...
class MainActivity : AppCompatActivity() {
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            val addressTask = GetAddressFromLatLong(this@MainActivity, latitude,longitude)
            addressTask.setAddressListener(object: GetAddressFromLatLong.AddressListener{
                override fun onAddressFound(address:String?){
                    tv_name.text = address
                }
        ...
        if (!weatherResponseJsonString.isNullOrEmpty()) {
            ...
            for (i in weatherList.weather.indices) {
                ...
                tv_temp.text = weatherList.main.temp.toString() +
                            getUnit(application.resources.configuration.setLocale(Locale.getDefault()).toString())
