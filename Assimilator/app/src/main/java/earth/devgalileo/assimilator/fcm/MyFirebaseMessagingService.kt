package earth.devgalileo.assimilator.fcm
...
import earth.devgalileo.assimilator.activities.MainActivity
import earth.devgalileo.assimilator.activities.SignInActivity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendRegistrationToServer(token: String?) {
        ...
        val sharedPreferences =
            this.getSharedPreferences(Constants.ASSIMILATOR_PREFERENCES, Context.MODE_PRIVATE)
    ...
    private fun sendNotification(title: String, message: String) {
        ...
        val notificationBuilder =
            ...
            /* TODO (Step 8: Set the title and message for the notification
                 which will be visible in the notification tray.)*/
            // START
