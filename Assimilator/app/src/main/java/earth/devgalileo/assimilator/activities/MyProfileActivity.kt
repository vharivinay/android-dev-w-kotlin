...
class MyProfileActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_myProfile_Update.setOnClickListener{
    ...
    override fun onRequestPermissionsResult(
        ...
        if(requestCode == Constants.READ_STORAGE_PERMISSION_CODE){
            if(grantResults.isNotEmpty() &&
                ...
                Toast.makeText(this,
                "Enable permissions to access storage in the Settings",
                Toast.LENGTH_LONG)
            }
        }
    }
    ...
    private fun setupActionBar(){
        setSupportActionBar(toolbar_myProfile_activity)
        ...
        toolbar_myProfile_activity.setNavigationOnClickListener {
            onBackPressed()
        }
    }
